...
import time
from batch_download import download_url_v2
import sys
import argparse
...
for iput in os.listdir(INPUT_DIR):
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=5) as executor:  
        futures = [executor.submit(download_url_v2, record, log_writer, save_dir, rei, len(res)) for rei, record in enumerate(res)]
